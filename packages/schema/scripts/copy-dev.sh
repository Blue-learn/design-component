...
APP_PATH_V2="../../../blAppV2/node_modules/@blue-learn/schema"
WEB_PATH="../../../web/node_modules/@blue-learn/schema"
...
[ -d $APP_PATH_V2 ] && cp -R $BUILD_PATH $APP_PATH_V2 && echo "👉 Copy Schema -> BlueLearn-App ✅ "
[ -d $WEB_PATH ] && cp -R $BUILD_PATH $WEB_PATH && echo "👉 Copy Schema -> BlueLearn-Web ✅ "
