...
function BriefCase(props) {
	return (
		...
		>
			...
			/>
			<Path
				d="M11.667 10.833v.85c0 .909-.009 1.65-1.667 1.65-1.65 0-1.667-.733-1.667-1.641v-.859c0-.833 0-.833.834-.833h1.666c.834 0 .834 0 .834.833zM18.042 9.167a13.737 13.737 0 01-6.375 2.516"
				stroke={props.color}
				strokeMiterlimit={10}
				strokeLinecap="round"
				strokeLinejoin="round"
