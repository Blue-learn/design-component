...
const Button: ButtonComponentType = ({
    ...
    return (
        <Pressable
            style={[styles.container, type === ButtonType.Primary ? styles.primaryButton : styles.secondaryButton]}
            onPress={onPress}
        >
            <Text style={type === ButtonType.Primary ? styles.primaryLabel : styles.secondaryLabel}>{label}</Text>
            {loading && (
                <ActivityIndicator
